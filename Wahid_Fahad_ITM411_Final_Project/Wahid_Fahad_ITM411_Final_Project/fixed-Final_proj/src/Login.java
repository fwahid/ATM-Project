...
public class Login {
    ...
    public void createTable(){
		  ...
		  final String createTable = "CREATE TABLE IF NOT EXISTS " +
				 " fahadUsers1(user_id INT AUTO_INCREMENT PRIMARY KEY, user_name VARCHAR(30), " +
				  "user_password VARCHAR(256), user_type INT)";
		  
		  final String create_requests = "CREATE TABLE IF NOT EXISTS " +
					 " fahad_requests3(req_id INT AUTO_INCREMENT PRIMARY KEY, user_name VARCHAR(30), " +
			  ...
			  //and PASS that data into your record objects' setters 
			    for (List<String> rowData: array){
				  //perform inserts into users table
				   ...
				   sql="insert into fahadUsers1(user_name,user_password,user_type) " +
    ...
    private void prepareGUI(){
        ...
        mainFrame.getContentPane().setForeground(SystemColor.activeCaption);
        mainFrame.setBackground(SystemColor.activeCaption);
        mainFrame.getContentPane().setBackground(UIManager.getColor("FormattedTextField.foreground"));
        mainFrame.setSize(504,335);
        ...
        headerLabel.setBackground(UIManager.getColor("FormattedTextField.selectionBackground"));
        headerLabel.setForeground(Color.WHITE);
        headerLabel.setFont(new Font("Tahoma", Font.PLAIN, 35));
        headerLabel.setBounds(0, 0, 498, 122);
        
        controlPanel = new JPanel();
        //controlPanel.setOpaque(false);
        controlPanel.setBackground(Color.RED);
        controlPanel.setBounds(12, 135, 478, 45);
    ...
    private void showTextFields(){
        ...
        headerLabel.setText("IIT Help Desk");
        ...
        loginButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
               ...
               /*verify user with a matching password/username from users table
                 *give pop-up message if either username or password is incorrect
               */
            	  Connection connect = null;
       		  Statement statement = null;
       		  ...
       		  try {
       		     ...
       		     username = userText.getText();
       		      ...
       		      String sql = "SELECT user_name, user_password, user_type FROM fahadUsers1 WHERE user_name='" + username + "' " +
