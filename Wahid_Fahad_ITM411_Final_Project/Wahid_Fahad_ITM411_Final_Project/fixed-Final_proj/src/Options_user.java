...
// User panel...
	...
	{	
		// vars. for SQL Query create
		  String createTable = "CREATE TABLE fahadTicket5(ticket_id INT AUTO_INCREMENT PRIMARY KEY, ticket_name VARCHAR(200), ticket_description VARCHAR(200), priority VARCHAR(100), status VARCHAR(20), create_date TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, Close_Date TIMESTAMP NULL)";
	...
	public Options_user() {
		...
		btnViewTicket.setBackground(Color.RED);
		...
		btnViewTicket.setBounds(10, 293, 423, 51);
		contentPane.add(btnViewTicket);
		
		JButton btnEditTicket = new JButton("LOG-OUT");
		btnEditTicket.setForeground(Color.WHITE);
		btnEditTicket.setBackground(Color.RED);
		...
		btnEditTicket.setBounds(322, 472, 111, 25);
		contentPane.add(btnEditTicket);
		
		JLabel lblPleaseChooseAn = new JLabel("WELCOME");
		...
		lblPleaseChooseAn.setBounds(0, 0, 445, 61);
		contentPane.add(lblPleaseChooseAn);
		// new ticket creating option
		JButton btnNewRequest = new JButton("NEW TICKET");
		btnNewRequest.setFont(new Font("Arial Black", Font.PLAIN, 13));
		btnNewRequest.setForeground(Color.WHITE);
		btnNewRequest.setBackground(Color.RED);
		...
		btnNewRequest.setBounds(10, 100, 423, 51);
		contentPane.add(btnNewRequest);
		
		//view all tickets option
		JButton btnViewAllTickets = new JButton("VIEW YOUR TICKETS");
		btnViewAllTickets.setForeground(Color.WHITE);
		btnViewAllTickets.setBackground(Color.RED);
		btnViewAllTickets.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				try {
		            ...
		            String by_ID = "SELECT * FROM fahadTicket5 WHERE ticket_name='" + current_user + "';";
		...
		btnViewAllTickets.setFont(new Font("Arial Black", Font.PLAIN, 13));
		btnViewAllTickets.setBounds(10, 357, 423, 51);
		contentPane.add(btnViewAllTickets);
		
		// Button for ticket close request
		JButton btnAdminRequest = new JButton("REQUEST TICKET CLOSE");
		btnAdminRequest.setFont(new Font("Arial Black", Font.PLAIN, 13));
		btnAdminRequest.setForeground(Color.WHITE);
		btnAdminRequest.setBackground(Color.RED);
			...
			public void mouseClicked(MouseEvent e) {
		        ...
		        if (result == JOptionPane.OK_OPTION) {
		        	 try {
		 	            ...
		 	            String sql1 = "SELECT * FROM fahadTicket5 WHERE ticket_id='" + field1.getText() + "';";
				       ...
				       if (blnFound) {
		 	            ...
		 	            int result1 = statement.executeUpdate("Insert into fahad_requests3(user_name, ticket_id, description) values('"+current_user+"','"+field1.getText()+"','"+field2.getText()+"')", Statement.RETURN_GENERATED_KEYS);
		...
		btnAdminRequest.setBounds(12, 165, 421, 51);
		contentPane.add(btnAdminRequest);
		
		//close request button...
		JButton btnViewCloseRequests = new JButton("VIEW CLOSE REQUESTS");
		btnViewCloseRequests.setForeground(Color.WHITE);
		btnViewCloseRequests.setFont(new Font("Arial Black", Font.PLAIN, 13));
		btnViewCloseRequests.setBackground(Color.RED);
		btnViewCloseRequests.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				try {
		            ...
		            String by_ID = "SELECT * FROM fahad_requests3 WHERE user_name='" + current_user + "';";
		...
		btnViewCloseRequests.setBounds(12, 229, 421, 51);
    ...
    private static void newTicketMaker() {
        ...
        if (result == JOptionPane.OK_OPTION) {
        	 try {
 	            ...
 	            int result1 = statement.executeUpdate("Insert into fahadTicket5(ticket_name, ticket_description, priority, status, create_date) values('"+current_user+"','"+field2.getText()+"','"+combo.getSelectedItem()+"', '"+status+"', '"+new java.sql.Timestamp(new java.util.Date().getTime())+"')", Statement.RETURN_GENERATED_KEYS);
